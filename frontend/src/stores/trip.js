...
export const useTripStore = defineStore('trip', () => {
    ...
    const travelPlan = ref(saved?.plan || null);
    const itinerary = ref(saved?.itinerary || []);
